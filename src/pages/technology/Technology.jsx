  ...
  return (
    <div className="w-full">
      ...
      <div className="h-[465px] w-full bg-tech-comp flex flex-col justify-center items-center space-y-4">
        ...
        <p className="text-para md:text-sm text-xs md:w-full text-center w-5/6">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Incidunt,
          aspernatur. ipsum dolor sit amet consectetur adipisicing elit.
          Incidunt, aspernatur.
        </p>
      </div>
      <div className="w-full flex flex-col items-center lg:space-y-10 space-y-5 mt-20  p-5 2xl:p-0 lg:p-10">
        ...
        <div className="2xl:w-2/3 lg:3/4 w-full flex lg:flex-row flex-col lg:space-x-20 space-x-0 space-y-5 lg:space-y-0 ">
          ...
          <div className="lg:w-max w-full grid  grid-cols-4 h-max lg:grid-cols-2 lg:gap-x-8 gap-x-3 gap-y-3 lg:gap-y-3 md:place-items-center ">
            <div className="flex flex-col space-y-3 items-center">
              <div className="bg-primaryLight lg:h-52 lg:w-52 h-16 w-16 rounded-md flex justify-center items-center">
                <img
                  src={printing}
                  alt=""
                  className="md:h-20 h-12 w-auto lg:h-max"
                ></img>
              </div>
            ...
            <div className="flex flex-col space-y-3 items-center">
              <div className="bg-secondary lg:h-52 lg:w-52 h-16 w-16 rounded-md flex justify-center items-center">
                <img
                  src={foiling}
                  alt=""
                  className="md:h-20 h-12 w-auto lg:h-max"
              ...
              <p className="text-xs md:text-lg text-center">Hot foiling</p>
            </div>
            <div className="flex flex-col space-y-3 items-center">
              <div className="bg-secondary lg:h-52 lg:w-52 h-16 w-16 rounded-md flex justify-center items-center">
                <img
            ...
            <div className="flex flex-col space-y-3 items-center">
              ...
              <p className="text-xs md:text-lg text-center">Labeling</p>
            </div>
          </div>
        </div>
      </div>
